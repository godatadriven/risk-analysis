...
class Game(object):
    ...
    def assign_missions(n_players):
        """ Randomly assign missions to players. 
            ...
            Returns:
                list: of missions, one for each player. """
    ...
    def initialize_single_army(self):
        """ Have each player place one army on the board, if they have one left. 
            ...
            Returns:
                bool, True if at least one player has placed a new army. False if
    ...
    def play_turn(self):
        """ Play a turn.
            The turn consists of three stages:
                ...
                - attack,
                - fortification. """
        assert self.is_alive(self.current_player_id), 'Player cannot perform a turn, he is game-over!'
    ...
    def attack(self, player):
        ...
        while True:
            ...
            if attack is None:
                break
            assert self.current_player_id == self.board.owner(attack[0]), \
                'Game: invalid attack: player attacks with armies of another player'
    ...
    def fortify(self, player):
        ...
        if fortification is not None:
            assert self.current_player_id == self.board.owner(fortification[0]), \
                'Game: invalid fortification: player moves armies of another player'
